...
5) Main file.R --> stepAIC, Model fitting (GLM), Validation, Extracting final best model, Prediction, Response curve generation based on Elith et al., 2005. Systematic Conservation Planning using prioritizr (Hanson et al., 2025), Priority Index
